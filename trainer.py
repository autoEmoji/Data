...
#     print("open data")
#     with open(address + "messages.p",'rb') as db_file:
#         all_data = list(pickle.load(db_file))
#         print(type(all_data))
#     print("open lables")
#     with open(address + "emojis.p",'rb') as db_file:
...
#     with open(address + "classifier.p", "wb") as newfile:
#         pickle.dump(algorithms, newfile)
#     with open(address + "vectorizer.p", "wb") as newfile:
#         pickle.dump(vec, newfile)
#     print("done saving")
#     # save the classes to a pickle:
#     with open(address + "classes.p",'wb') as classes_file:
#         pickle.dump(algorithms.classes_,classes_file)
#
# def test(prefix):
#
